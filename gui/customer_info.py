...
def customer_info(master, func, handle):
    ...
    identry = tk.Entry(search_line, textvariable=customer_id, width=25, bd=0, font=myFont, bg='lightsteelblue')
    ...
    identry = tk.Entry(search_line0, textvariable=customer_name, width=25, bd=0, font=myFont, bg='lightsteelblue')
