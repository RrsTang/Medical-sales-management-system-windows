...
def supplier_info(master, func, handle):
    ...
    identry_id = tk.Entry(search_line, textvariable=supplier_id, width=25, bd=0, font=myFont, bg='lightsteelblue')
    ...
    identry_name = tk.Entry(search_line0, textvariable=supplier_name, width=25, bd=0, font=myFont, bg='lightsteelblue')
